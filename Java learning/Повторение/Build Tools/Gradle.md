...
Скрипты настроек: Скрипты настроек могут быть либо файлами settings.gradle на Groovy, либо файлами settings.gradle.kts на Kotlin.
